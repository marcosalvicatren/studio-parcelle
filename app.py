...
from excel_parser import parse_clients_file, VALID_TYPES, COLUMN_LABELS
...
<style>
    ...
    [data-testid="stSidebar"] h3 {color: #ffffff !important; font-size: 1.1rem;}
    [data-testid="stSidebar"] .stRadio label {color: #e8f0f7 !important;}
    [data-testid="stSidebar"] small {color: #a0b4c8 !important;}
    [data-testid="stSidebar"] hr {border-color: #2e6da4;}
